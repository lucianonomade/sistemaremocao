    ...
    <div className="space-y-8 animate-in pb-20">
      ...
      <div className="bg-[#161B22] border border-[#30363D] rounded-[2.5rem] overflow-hidden shadow-2xl">
        <table className="w-full text-left">
          <thead className="bg-[#0D1117]/50 border-b border-[#30363D]">
            <tr>
              <th className="px-8 py-5 text-[10px] font-black text-[#8B949E] uppercase">Data / ID</th>
              <th className="px-8 py-5 text-[10px] font-black text-[#8B949E] uppercase">Descrição</th>
              <th className="px-8 py-5 text-[10px] font-black text-[#8B949E] uppercase text-right">Valor</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#30363D]">
            {transactions.map((tx) => (
              <tr key={tx.id} className="hover:bg-white/[0.02]">
                ...
                <td className="px-8 py-6">
                  <p className="text-xs font-black uppercase tracking-tight text-white/90">{tx.description}</p>
                </td>
